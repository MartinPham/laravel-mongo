<?php namespace Martinpham\Mongodb\Query;
...
use Martinpham\Mongodb\Connection;
// use MongoDate;
// use MongoId;
use MongoRegex;
...
//            if ($this->hint)    $cursor->hint($this->hint);
    ...
    {
        $key = [
            'connection' => $this->connection->getCollectionName(),
...
//        }
    ...
    protected function compileWheres()
    {
        ...
        foreach ($wheres as $i => &$where)
        {
            ...
            {
                $where['value'] = new \MongoDB\BSON\UTCDateTime($where['value']->getTimestamp() * 1000);
            }
