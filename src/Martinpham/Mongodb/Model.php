<?php namespace Martinpham\Mongodb;

use Carbon\Carbon;
use DateTime;
use Illuminate\Database\Eloquent\Model as BaseModel;
use Illuminate\Database\Eloquent\Relations\Relation;
use Martinpham\Mongodb\Eloquent\Builder;
use Martinpham\Mongodb\Eloquent\HybridRelations;
use Martinpham\Mongodb\Query\Builder as QueryBuilder;
use Martinpham\Mongodb\Relations\EmbedsMany;
use Martinpham\Mongodb\Relations\EmbedsOne;
use Martinpham\Mongodb\Relations\EmbedsOneOrMany;
//use MongoDate;
// use MongoId;
...
//        parent::unserialize($data);
        unserialize($data);
//        $this->_id = new \MongoDB\BSON\ObjectID($this->_id);
    }
    ...
    {
//        var_dump([debug_backtrace(), $value]);die;
     ...
     * @return \Martinpham\Mongodb\Relations\EmbedsMany
     */
     ...
     * @param  string  $foreignKey
     * @param  string  $relation
     * @return \Martinpham\Mongodb\Relations\EmbedsOne
     */
     ...
     *
     * @param  \Martinpham\Mongodb\Query\Builder $query
     * @return \Martinpham\Mongodb\Eloquent\Builder|static
     */
